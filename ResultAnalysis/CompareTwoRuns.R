...
#Height
plot(y1,td1[7,1,], type="l", ylim=c(0,30), lwd=2, xlab="time (y)", ylab="Tree height (m)", main="Tree height\ninfile1 = green  infile2 = blue",col="darkgreen")
...
points(100*td2[8,1,],td2[7,1,], type="l", col="blue", lwd=2,lty=2)
abline(0,1,lwd=2)
...
#P / Af
plot(y1,td1[17,1,]/td1[37,1,], ylim=c(0,3), type="l", lwd=2,xlab="time (y)", ylab= "P/Af min, mean, max (kg C / m2)", main="Photosynthetic rate per unit needle area",col="darkgreen")
points(y2,td2[17,1,]/td2[37,1,], type="l", lwd=2,col="blue")


plot(y1,td1[35,1,]/(td1[37,1,]*td1[32,1,]), type="l",main="Radiation capture efficiency, related to STAR of tree", xlab="time (y)", ylab="Qabs/(Af*QinTop)",ylim=c(0,2),col="darkgreen")
...
#Basal area
plot(y1,pi*(td1[8,1,])^2*dens1/4, ylim=c(0,80),type="l", lwd=2,xlab="time (y)", ylab= "m2/ha", main="Basal area",col="darkgreen")
points(y2,pi*(td2[8,1,])^2*dens2/4,type="l", lwd=2, col="blue")

#Basal area at crown base
plot(y1,pi*(td1[10,1,])^2*dens1/4, ylim=c(0,60),type="l", lwd=2,xlab="time (y)", ylab= "m2/ha", main="Basal area at crown base",col="darkgreen")
points(y2,pi*(td2[10,1,])^2*dens2/4,type="l", lwd=2, col="blue")

#Stem volume
plot(y1,td1[16,1,]*dens1, ylim=c(0,1000),type="l", lwd=2,xlab="time (y)", ylab= "m3/ha", main="Stem volume",col="darkgreen")
...
plot(y1,td1[17,1,]*dens1/1000,type="l", lwd=2,xlab="time (y)", ylab= "t C / ha", main="GPP (solid), Respiration (dashed)",ylim=c(0,15),col="darkgreen")
