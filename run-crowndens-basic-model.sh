...
./crowndens 60 MetaFile.txt -metafile MetaFile.txt -iter 60  -voxelspace VoxelSpace.txt -voxelCalculation 5 -numParts 2 -hw 10 -kBorderConifer 0.11 -modeChange 20 -architectureChange 5 -aChangeStart 20 -Lmaxturn 80 -writeInterval 5 -increaseXi 15  -hdf5 fip1-2fgo1-x1ac5.h5
