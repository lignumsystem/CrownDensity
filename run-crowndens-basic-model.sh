...
./crowndens 60 MetaFile.txt -metafile MetaFile.txt -iter 60 -voxelspace VoxelSpace.txt  -voxelCalculation 5 -modeChange 20 -architectureChange 20 -fipmode fip1.fun -fgomode fgo1.fun -numParts 2 -hw 10 -kBorderConifer 0.11   -writeInterval 5 -increaseXi 100  -hdf5 CrownDensity-147-Basic-ModeChange-40.h5
