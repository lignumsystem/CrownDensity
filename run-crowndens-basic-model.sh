...
./crowndens 60 MetaFile.txt -metafile MetaFile.txt -iter 60 -voxelspace VoxelSpace.txt  -voxelCalculation 5 -modeChange 20 -architectureChange 10 -numParts 2 -hw 10 -kBorderConifer 0.11  -writeInterval 5 -increaseXi 15  -hdf5 Oct23-75-7.h5 -random_variation
