...
./crowndens 40 MetaFile.txt -metafile MetaFile.txt -iter 40 -voxelspace VoxelSpace.txt  -voxelCalculation 5 -numParts 2 -hw 10 -kBorderConifer 0.11 -EBH -verbose  -writeInterval 5 -increaseXi 15 -adHoc -RUE 1.0 -EBHREDUCTION 0.99 -EBHFINAL 0.5 -EBHInput 2 -hdf5 koe.h5 -modeChange 20
